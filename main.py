...
st.set_page_config(
    page_title="CreditCraft: Advanced Credit Risk Assessment",
    page_icon="🏦",
    layout="wide",
...
with tab3:
    ...
    with doc_col2:
        ...
        **Model Testing Team**:
        ...
        - [Model API Documentation](https://docs.creditcraft.com)
        - [Risk Management Guidelines](https://risk.creditcraft.com)
        - [Regulatory Compliance](https://compliance.creditcraft.com)
...
<div style="text-align: center; color: #666; padding: 2rem;">
    <p>© 2025 CreditCraft. Advanced Credit Risk Assessment Platform.</p>
